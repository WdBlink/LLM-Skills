...
The output JSON includes:
  ...
  - Issue detection: text overflow and shape overlaps
    ...
    if Presentation is None:
        print("Error: Missing dependency python-pptx. Install it before running inventory.py.")
        sys.exit(1)
    if Image is None or ImageDraw is None or ImageFont is None:
        print("Error: Missing dependency Pillow. Install it before running inventory.py.")
        sys.exit(1)
